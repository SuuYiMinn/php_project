...
<body>
    ...
    <div class="relative overflow-x-auto">
        <table class="lg:w-4/5 w-5/6 text-sm text-left text-gray-500 dark:text-gray-400 mx-auto">
            ...
            <tbody>
                ...
                foreach ($wish_product_result as $wish_product) {
                    ...
                    if ($wish_p_discount != null) {
                        ...
                        $price = $sell_price; ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 wishlist_products" id="<?=$wish_product["product_id"]?>">
