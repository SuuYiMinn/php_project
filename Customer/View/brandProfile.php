        ...
        <div class="w-full flex justify-evenly py-2 lg:invisible sm:visible absolute top-0 bg-white">
            ...
            <searchBar class="relative">
             ...
             bg-white w-48 border border-slate-300 rounded-md py-[2px] pl-8 pr-3 focus:outline-none focus:border-sky-500
              focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search for anything..." type="text" name="search" id="brand_product_search_mobile" />
        ...
        ?>
            ...
            <a href="./detailpage.php?productid=<?= $brand_product["id"] ?>" class="lg:w-60 w-40 lg:h-60  h-40 bg-white drop-shadow-md my-2 mx-1" id="product_<?= $brand_product["id"] ?>">
                ...
                <div class="w-full lg:h-2/3 h-3/5 relative">
                    <img src="../..<?= $brand_product["p_photo_1"] ?>" alt="product_photo" class="w-full h-full">
                </div>
                <!-- product information -->
