...
<body>
  ...
  <section class=" w-full flex lg:flex-row flex-col justify-around">
    ...
    <div class="lg:w-3/5 w-11/12 mx-auto cart_p_section">
      ...
      <table class="lg:w-full w-full text-sm text-left text-gray-500 dark:text-gray-400 mx-auto">
        <thead class="lg:text-xs text-[10px] text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
        ...
        <tbody class="h-76 overflow-y-auto lg:text-sm text-[10px] product_table">
          ...
          ?>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 product_cart" id="<?= $cart_product["product_id"] ?>">
              <th scope="row" class="lg:px-6 px-2 lg:py-3 py-1 font-medium  whitespace-nowrap dark:text-white">
                <?= $count ?>
              </th>
              <td class="lg:px-6 px-2 lg:py-3 py-1">

                <div class=" lg:w-20 w-10 h-12 ml-2 lg:h-24">
    ...
    <td class="lg:px-6 px-2 lg:py-3 py-1">
      ...
      <div class="flex items-center lg:w-28 w-16 justify-evenly">
        <p>Qty</p>
        <div class="lg:w-3 w-2 lg:h-3 h-2 bg-green-700  relative  rounded-sm remove">
          <ion-icon name="remove-outline" class="w-full h-full absolute text-white font-bold"></ion-icon>
        </div>
        <p class="qty"><?=$cart_product["qty"]?></p>
        <div class="lg:w-3 w-2 lg:h-3 h-2 bg-green-700  relative  rounded-sm add">
