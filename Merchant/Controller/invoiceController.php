...
$sql = $pdo->prepare(
    " SELECT m_customers.c_email, m_products.p_sell_price, t_order.id,m_products.p_title, t_order.total_amt, m_products.p_sell_price AS unit_price, m_products.p_detail, t_order_detail.qty, m_customers.c_name,
