...
<body>
    <!-- start of header -->
    <div class="flex flex-row mb-1 top-0 bg-white sticky">
        <!-- start of logo -->
        <div>
        ...
        <div class="mt-5 ml-[350px]">
            <p class="font-ABeeZee font-bold text-3xl text-blueText">
                <span>Welcome Back,</span>
            </p>
            <p class="mt-1 font-ABeeZee text-greyText1 italic font-bold text-smallText textl-xl mb-2">Here's what happening with your shop</p>
        </div>
        <!-- end of title -->
    </div>
    <!-- end of header -->
    ...
    <!-- start of lower -->
        ...
        <!-- start of left side -->
        <aside class="bg-whiteText fixed z-40 px-0 pt-0 pb-2 shadow-3xl rounded-lg">
            <!-- start of dashboard -->
