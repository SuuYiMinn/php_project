...
<body>
    <?php include "../Layout/nav.php"; ?>   
        <!-- start of right side -->
        <div class="ml-[600px] w-[800px] px-10 py-8 shadow-3xl flex flex-col mb-10 justify-center items-center">
            <!-- title of Edit profile -->
            <div class="flex flex-col justify-center items-center">
                <div class="text-orange text-xl font-bold mb-2">Edit Profile</div>
                <div class="w-[300px] h-[3px] bg-inputBox shadow-3xl"></div>
            </div>
            <!-- Edit profile picture -->
            <div class="flex flex-row space-x-[200px] mt-10">
                <div class="text-blueText text-xl font-bold">Profile Picture:</div>
                <div class="relative">
            ...
            <!-- Edit Shop info -->
            <div class=" mt-10 space-x-[200px] flex flex-row">
                <div class="text-blueText text-xl font-bold mb-5">Shop Info:</div>
                <div>
                    <form class="space-y-5" action="" method="">
                        ...
                        <div>
                            ...
                            <input id="name" name="name" type="text" required class="block w-lg rounded-lg border border-blueText px-20 py-2 text-blueText shadow-sm focus:ring-blueText focus:border-blueText placeholder:text-greyText1 text:lg pl-[45px]" placeholder="Shop Name">
                        </div>
                        ...
                        <div>
                            ...
                            <input id="name" name="name" type="text" required class="block w-lg rounded-lg border border-blueText px-20 py-2 text-blueText shadow-sm focus:ring-blueText focus:border-blueText placeholder:text-greyText1 text:lg pl-[45px]" placeholder="suuyiminn@gmail.com">
                        </div>
                        <!-- edit phone no -->
                        <div>
                            <label for="name"></label>
                            ...
                            <input id="name" name="name" type="text" required class="block w-lg rounded-lg border border-blueText px-20 py-2 text-blueText shadow-sm focus:ring-blueText focus:border-blueText placeholder:text-greyText1 text:lg pl-[45px]" placeholder="09944138580">
                        </div>
                        <!-- edit region -->
                        ...
                        <div>
                            ...
                            <input id="name" name="name" type="text" required class="block w-lg rounded-lg border border-blueText px-20 py-2 text-blueText shadow-sm focus:ring-blueText focus:border-blueText placeholder:text-greyText1 text:lg pl-[45px]" placeholder="no234,blockwlo, eoneouewi">
                        </div>
                        ...
                        <div class="flex flex-row space-x-20">
                            ...
                            <div class="mt-6">
                                <button type="button" class="text-whiteText rounded-lg px-[30px] py-1.5 bg-button border border-button  text-xl font-RobotoSlab shadow-sm hover:bg-orange focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange">Cancel</button>
                            </div>
