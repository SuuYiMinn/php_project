$(document).ready(function () {
    $(".status").change(function () {
      ...
      $.ajax({
        url: "../../Controller/orderDoneController.php",
        type: "POST",
        data: {
                                ...
                                <div class="">
                                    <div class="relative flex flex-wrap items-center xl:justify-between -mx-4 mb-1 pb-5 border-b border-gray-200 border-opacity-40">
                                        ...
                                        <div class="w-full md:w-auto mb-6 xl:mb-0">
                                            <a class="block mb-5 text-md font-heading font-medium hover:underline" href="#">${inner.p_title}</a>
                                            <div class="flex flex-wrap">
                                                <p class="mr-4 text-sm font-medium">
                                                    <span class="font-heading">${inner.p_detail}</span>
