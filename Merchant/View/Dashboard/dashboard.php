        ...
        <div class="">
            ...
            <div class="flex flex-row">
                ...
                <div class="w-[200px] h-[120px] text-center bg-whiteText shadow-3xl rounded-2xl">
                    ...
                    <p class="mt-3 font-Tommorrow italic font-bold text-md text-greyText1">12900 Ks</p>
                </div>
                <!-- end of total sales -->
                <!-- start of registration fee -->

                <div class="w-[200px] h-[120px] ml-10 text-center bg-whiteText shadow-3xl rounded-2xl">
                    <p class="mt-8 font-ABeeZee font-bold text-blueText text-xl">30 Days left</p>
                    <p class="mt-3 font-Tommorrow italic font-bold text-md text-greyText1">For Registration Fee</p>
                ...
                <div class="w-[200px] h-[120px] ml-10 text-center bg-whiteText shadow-3xl rounded-2xl">
                    ...
                    <p class="mt-3 font-Tommorrow italic font-bold text-md text-greyText1">340</p>
            ...
            <div class="flex flex-row mt-5 mb-10">
                ...
                <div class="">
                    ...
                    <div class="flex flex-row justify-center items-center w-[500px] h-[80px] py-14 px-5 shadow-3xl rounded-xl mt-5">
                        <!-- image of customer -->
                ...
                <div class="ml-20">
                    ...
                    <div class="flex flex-row justify-center items-center w-[450px] h-[80px] shadow-3xl rounded-xl mt-5">
                        ...
                        <img src="../resources/img/top-product.png" class="w-[80px] h-[60px]" />
