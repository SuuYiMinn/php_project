...
<body>
    ...
    <div class=" ml-[400px] px-10 py-5 flex flex-col justify-center items-center mb-10">
        ...
        <div class="flex flex-col justify-center items-center">
            <div class="text-orange text-xl text-center font-bold mb-5">Edit Product</div>
        ...
        <div class=" mt-10 flex flex-row justify-center">
            ...
            <div class="flex flex-row space-x-20 ml-[900px] mt-10">
                    <div class="mt-6">
                        <button type="button" class="text-white rounded-lg px-[30px] py-1.5 bg-orange  text-xl font-RobotoSlab shadow-sm hover:bg-orange focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange">Delete</button>
                    </div>
                    <div class="mt-6">
                        <button type="button" class="text-whiteText rounded-lg px-[30px] py-1.5 bg-button border border-button  text-xl font-RobotoSlab shadow-sm hover:bg-orange focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange">Save</button>
                    </div>
