...
<body>
    ...
    <div class="flex flex-row">
        ...
        <div class="ml-[250px] flex flex-wrap justify-center items-center">
        <div class="mt-32 max-w-sm bg-white rounded-lg shadow-3xl dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img class="rounded-t-lg" src="../resources/img/product.jpg" alt="" />
            </a>
            <div class="px-5 pb-5">
                <a href="#" class="">
                    <h5 class="mt-5 text-xl font-semibold tracking-tight text-blueText dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h5>
                </a>
                <div class="flex items-center mt-2.5 mb-5">
                    <svg class="fill-orange w-7 h-7 text-yellow-300 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                    ...
                    <svg class="fill-orange w-7 h-7 text-gray-200 dark:text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                        <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z" />
                    </svg>
                    <span class="bg-blue-100 text-blueText text-xl font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">5.0</span>
                </div>
                <div class="flex items-center justify-between">
                    <span class="text-3xl font-bold text-blueText dark:text-white">$599</span>
                    <a href="#" class="inline-flex items-center px-3 py-2 text-xl font-medium text-center text-whiteText bg-orange rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
        ...
        <div class="ml-20 mt-32 max-w-sm bg-white rounded-lg shadow-3xl dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img class="rounded-t-lg" src="../resources/img/product.jpg" alt="" />
            </a>
            <div class="px-5 pb-5">
