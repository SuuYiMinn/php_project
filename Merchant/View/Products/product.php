...
<head>
    ...
    <script src="../resources/js/menuCategory.js"></script>
</head>
            ...
            <div class="mt-10 max-w-[250px] bg-white rounded-lg shadow-3xl">
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center mt-2.5 mb-5">
                        ...
                        <svg class="fill-orange w-3 h-3 text-gray-200 dark:text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                            <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z" />
                        </svg>
                        <span class="bg-blue-100 text-blueText text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">5.0</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-xl font-bold text-blueText dark:text-white"><?php echo $product["p_sell_price"] ?>Ks</span>

                        <a href="../../Controller/productDetailsController.php?id=<?= $product["id"] ?>" name="pDetailsBtn" class="inline-flex items-center px-2 py-1 text-xs font-medium text-center text-whiteText bg-orange rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Read more
