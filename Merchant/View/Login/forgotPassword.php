    ...
    <div class="flex flex-row justify-center mt-28">
        <div class="flex flex-col justify-center px-8 py-10 bg-whiteText border-4 border-whiteText rounded-2xl drop-shadow-md">
            <form class="" action="" method="">
                ...
                <div class="mt-6">
                    <button type="button" class="rounded-full px-[118px] py-1.5 bg-button  text-xl font-RobotoSlab text-whiteText shadow-sm hover:bg-orange focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange">Continue</button>
                </div>
                <div class="mt-2">
